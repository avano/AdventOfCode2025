...
class Day08Test extends AocSupport {
	@ParameterizedTest
	@MethodSource('part1')
	void part1Test(List<String> input, int result) {
		assert new Day08().part1(input, 10) == result
	}

	@ParameterizedTest
	@MethodSource('part2')
	void part2Test(List<String> input, int result) {
		assert new Day08().part2(input) == result
	}

	static Stream<Arguments> part1() {
		return Stream.of(
				Arguments.of(testFileAs(List.class), 40)
		)
	}

	static Stream<Arguments> part2() {
		return Stream.of(
				Arguments.of(testFileAs(List.class), 25272)
		)
	}
}
